...
export const Phones: React.FC<PropsWithLang> = ({ lang }) => {
  ...
  return (
    <div className="w-[95%] mx-auto pt-10 px-4 md:px-0 grid text-center items-center rounded-[30px] bg-white/30 border border-[rgba(239,239,243,0.5)] shadow-[0_4px_24px_0_rgba(0,0,0,0.2)] backdrop-blur-[20px]">
      <div className="grid gap-3 max-w-[700px] mx-auto px-4">
        <h2 className="font-bold leading-tight sm:leading-snug md:leading-[60px] text-2xl sm:text-3xl md:text-4xl lg:text-[48px] text-center">
          {t.title}
        </h2>
      ...
      <Image
        ...
        width={500}
        height={300}
        className="w-[85%] sm:w-[75%] md:w-[70%] mx-auto h-auto -mt-5 md:-mt-10"
      />
    </div>
  );
};
