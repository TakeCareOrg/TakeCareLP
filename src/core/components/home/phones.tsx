...
export const Phones: React.FC<PropsWithLang> = ({ lang }) => {
  ...
  return (
    <div className="w-[95%] h-screen mx-auto pt-10 px-4 md:px-0 grid text-center items-center rounded-[30px] bg-white/30 border border-[rgba(239,239,243,0.5)] shadow-[0_4px_24px_0_rgba(0,0,0,0.2)]">
